...
주요 기능 (Features)
Real-time Scoring: Web Audio API를 통해 마이크 입력 주파수를 분석, 음정 변화와 성량을 체크하여 점수 산정.

Visualizer: 캔버스 API를 이용한 실시간 오디오 스펙트럼 시각화.

Club Mode: 시각적 몰입감을 높이는 동적 배경 조명 효과.
...
Video: YouTube IFrame API (For Legal Compliance)
...
원저작권사 공식 문의: 콘텐츠 사용의 정당성을 확보하기 위해 TJ미디어(ziller.co.kr) 제휴 창구를 통해 **'유튜브 콘텐츠 사용 및 포트폴리오 활용 승인'**을 공식 요청하였습니다.
